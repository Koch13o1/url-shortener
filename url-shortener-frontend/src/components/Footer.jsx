        ...
        <footer className="bg-custom-gradient text-white py-8 z-40 relative">
            <div className="container mx-auto px-6 lg:px-14 flex flex-col lg:flex-row lg:justify-between items-center gap-4">
                ...
                <p className="mt-4 lg:mt-0">
                    &copy; 2024 Koch Holdings. All rights reserved.
                </p>

                <div className="flex space-x-6 mt-4 lg:mt-0">
                    <a href="https://github.com/Koch13o1" className="hover:text-gray-200">
                        <FaGithub size={24} />
                    </a>
                    ...
                    <a href="https://www.linkedin.com/in/maitreya-kocharekar/" className="hover:text-gray-200">
                        <FaLinkedin size={24} />
                    </a>
                </div>
            </div>
